namespace WebApp.Models
{
    public class CategoriesRepository
    {
        ...
        {
            new Category {CategoryId=1,Name="Beverage",Description="somthing about beverage"},
            new Category {CategoryId=2,Name="Bakery",Description="somthing about Bakery"},
            new Category {CategoryId=3,Name="Meat",Description="somthing about Meat"}
        };
